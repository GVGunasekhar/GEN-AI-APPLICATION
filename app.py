...
with open(r"C:\Users\Pc\OneDrive\Desktop\GEN AI APPLICATION\key.txt","r") as f:
    key = f.read().strip()

# Configure the Generative AI API keys
genai.configure(api_key = "AIzaSyA9znM1aqqG6dzoHWhE2ZfM0SmqisG6hVA")
...
if st.button("Generate Review"):
    if user_prompt.strip():
        try:
            ...
            st.markdown("<h2 style='color: red;'>Corrected Code and Review:</h2>", unsafe_allow_html=True)
